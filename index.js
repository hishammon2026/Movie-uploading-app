...
app.get('/', async (req, res) => {
    ...
    <head>
        ...
        <style>
            ...
            .del-btn { position: absolute; top: 5px; right: 5px; background: rgba(255,0,0,0.8); color: white; border: none; border-radius: 50%; width: 25px; height: 25px; z-index: 10; font-weight: bold; }
            ...
            .close-btn { position: absolute; top: 20px; right: 20px; color: #fff; font-size: 35px; background: rgba(0,0,0,0.5); border: none; z-index: 2100; border-radius: 50%; }
    ...
    <body>
        <header>
            <div style="color:var(--gold); font-weight:bold;">ANIMEZONE VLC PRO 🏴‍☠️</div>
            <input type="text" id="srch" class="search-box" placeholder="Search..." onkeyup="search()">
        </header>
        <div class="grid" id="g"></div>
        <div id="playerOverlay">
            <button class="close-btn" onclick="closeP()">&times;</button>
            <video id="v-player" class="video-js vjs-big-play-centered" controls preload="auto" width="100%"></video>
        </div>
        ...
        <script>
            ...
            function add() {
                ...
                const seriesName = prompt("Name:"), episodeTitle = prompt("Episode:"), pic = prompt("Poster:"), url = prompt("Video URL:");
                if(seriesName && url) {
